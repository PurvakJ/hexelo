  ...
  return (
    <div className="about">
      ...
      <section className="section testimonial-section">
        <div className="container">
          <div className="section-header">
            <span className="section-subtitle">Trusted by Many</span>
            <h2 className="section-title">What <span className="text-highlight">Customers Say</span></h2>
          </div>
          ...
          <div className="testimonial-grid">
            <div className="testimonial-card-large">
              ...
              <p className="testimonial-text">
                Hexelo has been our go-to hardware supplier for over a decade. Their quality is unmatched, and the personal attention from partners Suresh ji and Manish ji makes all the difference.
              </p>
              <div className="testimonial-author">
                <span className="author-name">Rajesh Construction Co.</span>
                <span className="author-location">Bathinda</span>
              </div>
            </div>
            <div className="testimonial-card-large">
              <div className="testimonial-quote">"</div>
              <p className="testimonial-text">
                The antique brass collection at Hexelo is simply exceptional. As an interior designer, I appreciate their deep product knowledge and willingness to source exactly what I need.
              </p>
              <div className="testimonial-author">
                <span className="author-name">Priya Interiors</span>
                <span className="author-location">Rajkot</span>
              </div>
            </div>
          </div>
        </div>
